...
| Propuesta | Acción | Estado |
| --- | --- | --- |
| Solicitud de que los detalles de un artista se abran en otra pestaña | No se tomará ninguna acción ya que no es nuestra intención que los detalles de los artistas o los productos muestren sus detalles en una nueva pestaña ya que esto puede hacer que a un usuario la aplicación le acabe abriendo varias pestañas y se sienta abrumado | <span style={{backgroundColor:"#ff0000"}}> Descartado </span> |
| Problemas con la perdida de permisos al cabo de un tiempo estando autenticado | Se ha detectado un problema en la autenticación y el problema será solucionado de cara a futuras versiones | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| Problema al intentar vender un producto en la aplicación, a pesar de enviar un formulario correcto, salta el mensaje “Error al enviar los datos” | Esto sucede por el problema comentado en la línea anterior y será solucionado | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| Cambiar el color de la calidad seleccionada en el custom design | Esta propuesta será implementada en la aplicación | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| Alerta cuando intentas añadir algo de lo que no hay stock o más cantidad de la que hay en stock | Se implementará una alerta para notificar a nuestros usuarios cuando intentan añadir al carrito un producto sin stock | <span style={{backgroundColor:"#00ff00"}}> Implementado </span> |
| Añadir un botón en los detalles de un producto para que te lleve a los detalles de su vendedor tras pulsarlo | Se implementará esta propuesta | <span style={{backgroundColor:"#00ff00"}}> Implementado </span> |
| Cambiar las alertas por mensajes | El equipo estudiará la viabilidad de hacer este cambio en el tercer sprint | <span style={{backgroundColor:"#0000ff"}}> En estudio</span> |
| Añadir imágenes a los usuarios | A partir de la siguiente versión, cuando un usuario se registre podrá añadir su imagen, así en la aplicación podrá ser más reconocible | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| Permitir más formatos para el visor 3D | Por motivos tecnológicos no podemos hacer esto ya que utilizamos un software externo que no nos lo permite y cambiar dicho software podría ser muy costoso, para paliar este problema, pondremos a disposición de los usuarios de la aplicación una funcionalidad donde podrán introducir un modelo en varios formatos y la aplicación lo convertirá a STL | <span style={{backgroundColor:"#ff0000"}}> Descartado </span>  |
| Añadir métodos de pago que permitan usar tarjeta de crédito | Realmente Paypal permite pagar con tarjeta de crédito, pero como la aplicación está en fase de desarrollo, para probar la aplicación sin cobros hay que utilizar la cuenta especial que se le proporciona a los usuarios pilotos, pero cuando la aplicación esté lanzada, se podrá comprar también con tarjeta de crédito | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| Permitir añadir los modelos STL cuando los vendemos | A partir de la siguiente versión cuando se suba un diseño a la aplicación el diseño en formato STL también se subirá y cuando un usuario compre dicho diseño, al usuario que lo compre se le enviará el diseño por correo | <span style={{backgroundColor:"#00ff00"}}> Implementado  </span> |
| Problemas cuando el código postal se autocompleta | Se ha detectado un problema cuando el código postal se autocompleta con los datos del usuario, por lo tanto, esta anomalía será solucionada para la siguiente versión | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| El visor 3d tiene una dirección en la que no te deja moverte | Esto es completamente normal y está pensado de esta forma para evitar problemas, de cara a futuras entregas se notificará en la guía que no se puede girar en todas las direcciones ya que el eje z está fijado | <span style={{backgroundColor:"#ff0000"}}> Descartado </span> |
| Obligar a poner contraseñas seguras | Realmente es importante que las contraseñas sean seguras, pero muchas veces el obligar a los usuarios a introducir contraseñas muy largas o difíciles los echa hacia atrás, por lo tanto, de cara a futuras entregas intentaremos encontrar un punto medio para la seguridad de las contraseñas | <span style={{backgroundColor:"#ffff00"}}> Implementado</span> |
| Sugerir contraseñas seguras | Esta funcionalidad puede aportar valor, pero no es prioritaría, por lo que el equipo la estudiará y si en el último sprint hay tiempo se implementará |<span style={{backgroundColor:"#0000ff"}}> Descartado</span> |
| No mostramos todos los campos en detalles del impresor | A partir de ahora en los detalles de un usuario mostraremos todos los datos de este excepto aquellos que sean personales | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| Permitir seleccionar el color de impresión | Esta funcionalidad será desarrollada en futuros lanzamientos y permitiremos a los usuarios elegir entre varios colores para solicitar su impresión | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| Cambiar mensaje de deslogueo exitoso | Este mensaje será cambiado | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| Mejorar el apartado de carrito que aparece cuando se pone el ratón sobre el logotipo | Se mejorará este apartado para que las fotos se vena mejor | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| Añadir placeholders | A partir de la siguiente versión intentaremos añadir placeholders a todos los formularios | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| Añadir botones de + y – al carrito | Dentro del carrito ya hay botones + y - para cambiar la cantidad seleccionada, el problema es que la cantidad tiene un color que no se observa correctamente, esto se mejorará | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
| Añadir opción de compra rápida de un objeto como amazon | Esta función aportaría mucho valor a la aplicación, el equipo estudiará su implementación de cara a próximas entregas | <span style={{backgroundColor:"#0000ff"}}> En estudio</span> |
...
| Añadir limitaciones en el número de caracteres en el registro | De cara al siguiente lanzamiento se añadirán limitaciones en el número de caracteres del registro | <span style={{backgroundColor:"#00ff00"}}> Implementado</span> |
...
| En lo comunidad se debería permitir ver mis propios posts en el feed | Este problema será solucionado de cara al siguiente lanzamiento | <span style={{backgroundColor:"#ffff00"}}> En desarrollo</span> |  id-8 |
| El campo nombre de los diseños permite solo campos en blanco | Este problema será solucionado de cara al siguiente lanzamiento | <span style={{backgroundColor:"#ffff00"}}> En desarrollo</span> |  id-9 |
| La conversión STL no ha funcionado | Esto se debe a problemas con la plataforma donde se aloja la aplicación, de cara a la siguiente entrega intentaremos mejorar su rendimiento en esta función, pero no podemos asegurar que lo consigamos | <span style={{backgroundColor:"#ffff00"}}> En desarrollo</span>  |  id-10 |
| Con el plan comprador no ha permitido destacar más de 3 productos | No nos consta este fallo, pero revisaremos porque se produce y lo corregiremos |  <span style={{backgroundColor:"#ffff00"}}> En desarrollo</span> |  id-11 |
| Si se edita un producto no dejará volverlo a destacar si ya se está en el límite | Este problema será solucionado de cara al siguiente lanzamiento |  <span style={{backgroundColor:"#ffff00"}}> En desarrollo</span> | id-12 |
